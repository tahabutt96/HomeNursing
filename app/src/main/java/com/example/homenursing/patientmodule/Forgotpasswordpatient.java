...
import com.example.homenursing.nursemodule.Forgetpasswordnurse;
...
public class Forgotpasswordpatient extends AppCompatActivity {
    ...
    private static String URL = "https://29e15b602a41.ngrok.io/home-nursing-mobileapp/forgetpasspatient.php";
...
//    }
//}
        Suuuubmit = (Button) findViewById(R.id.recoverpasspatient);
        uuuemail = (EditText) findViewById(R.id.forgetpasswordpatient);
        progress = new ProgressDialog(Forgotpasswordpatient.this);
...
//    }
    public void Forgot_Password() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String ServerResponse) {
                        ...
                        if (ServerResponse.toString().contains("Password containing mail sent.")) {
                            ...
                            Toast.makeText(Forgotpasswordpatient.this, "Mail Sent", Toast.LENGTH_LONG).show();
                        } else {
                            // Showing Echo Response Message Coming From Server.
                            Toast.makeText(Forgotpasswordpatient.this, ServerResponse, Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(Forgotpasswordpatient.this, volleyError.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Forgotpasswordpatient.this);
